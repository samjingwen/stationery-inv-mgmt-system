...
namespace Team7ADProject.ViewModels
{
    public class SideBarViewModel
    {
        ...
        public static List<SideBarViewModel> GenList()
        {
            ...
            menulist.Add(new SideBarViewModel() { Roles = "Department Head", SubMenu = "Stationery Management", Title = "Collection Point", Action = "Index", Controller = "CollectionPoint", IsAction = true });
            ...
            //Department Rep
            menulist.Add(new SideBarViewModel() { Roles = "Department Representative", Title = "Collection Point", Action = "Index", Controller = "CollectionPoint", IsAction = true });
